...
const Pagination = () => {
    return (
        <div class="wrapper-pagination-component">
            <div class="wrapper-pagination">
              ...
              <div class="pagination-numbers">
                <a href="#"><div class="_round-shape active-class active">1</div></a>
                <a href="#"><div class="_round-shape active-class">2</div></a>
                <a href="#"><div class="_round-shape active-class">3</div></a>
                <a href="#"><div class="_round-shape active-class">4</div></a>
                <a href="#"><div class="_round-shape active-class">5</div></a>
                <a href="#"><div class="_round-shape active-class">6</div></a>
                <a href="#"><div class="_round-shape active-class">7</div></a>
                <a href="#"><div class="_round-shape active-class">8</div></a>
                <a href="#"><div class="_round-shape active-class">9</div></a>
                <a href="#"><div class="_round-shape active-class">10</div></a>
                <a href="#"><div class="_round-shape active-class">11</div></a>
                <a href="#"><div class="_round-shape active-class">12</div></a>
              </div>
