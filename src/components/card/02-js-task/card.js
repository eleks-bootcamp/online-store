export default class Card {
  ...
  // сюда скопировали с файла HTML всю нижеследуюшюю часть кода карточки
  getTemplate () {
    const result = `
      <div class="blok-rama">
  ...
  // создадим метод update, который будет менять состояние
  update (data = {}) {
    this.state = data;
  ...
  myRender () {
    //создаем элемент div в который положим данные
