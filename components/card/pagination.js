export default Pagination {
  ...
  updata (data) {
  	this.paginator = data
  	this.container.innerHTML = renderProduct()
  }

  renderProduct () {
    return `
    <nav>
        <li class="back"><a href="#" data-element="page_link" class="page_link" data-page-index="0">
          <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
	        ...
	        <ul>
		        <li><a href="#" data-element="page_link" class="page_link active" data-page-index="0">1</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">2</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">3</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">4</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">5</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">6</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">7</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">8</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">9</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">10</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">11</a></li>
		        <li><a href="#" data-element="page_link" class="page_link" data-page-index="0">12</a></li>
	        </ul>
        <li class="next"><a href="#" data-element="page_link" class="page_link" data-page-index="0">
          <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    wrapper.innerHTML = this.renderProduct()
